...
def build_humanoid_proxy() -> None:
    ...
    empty_socket("col_chr_proto_humanoid_01_capsule", (0.0, 0.0, 0.92), root)
...
def build_wall_panel() -> None:
    ...
    empty_socket("socket_root", (0.0, 0.0, 0.0), root)
    empty_socket("socket_snap_left", (-2.0, 0.0, 1.25), root)
    empty_socket("socket_snap_right", (2.0, 0.0, 1.25), root)
...
def build_floor_tile() -> None:
    ...
    empty_socket("socket_root", (0.0, 0.0, 0.0), root)
    empty_socket("socket_snap_north", (0.0, 2.0, 0.0), root)
    empty_socket("socket_snap_east", (2.0, 0.0, 0.0), root)
    empty_socket("socket_snap_south", (0.0, -2.0, 0.0), root)
    empty_socket("socket_snap_west", (-2.0, 0.0, 0.0), root)
...
def build_cover_crate() -> None:
    ...
    empty_socket("socket_root", (0.0, 0.0, 0.0), root)
    empty_socket("socket_cover_top", (0.0, 0.0, 1.0), root)
...
def build_ramp() -> None:
    ...
    empty_socket("socket_root", (0.0, 0.0, 0.0), root)
    empty_socket("socket_low_edge", (-1.5, 0.0, 0.0), root)
    empty_socket("socket_high_edge", (1.5, 0.0, 1.0), root)
...
def build_target_stand() -> None:
    ...
    empty_socket("socket_root", (0.0, 0.0, 0.0), root)
    empty_socket("socket_target_center", (0.0, -0.12, 1.08), root)
...
def metadata_for(spec: AssetSpec, export_path: Path, stats: dict[str, int]) -> dict[str, object]:
    ...
    socket_contracts: dict[str, list[str]] = {
        "chr_proto_humanoid_01": ["socket_root", "socket_head"],
        "map_wall_panel_01": ["socket_root", "socket_snap_left", "socket_snap_right"],
        "map_floor_tile_01": [
            "socket_root",
            "socket_snap_north",
            "socket_snap_east",
        ...
        "map_cover_crate_01": ["socket_root", "socket_cover_top"],
        "map_ramp_01": ["socket_root", "socket_low_edge", "socket_high_edge"],
        "map_target_stand_01": ["socket_root", "socket_target_center"],
    }
    if spec.asset_id in socket_contracts:
        metadata["sockets"] = socket_contracts[spec.asset_id]
        metadata["socket_generation"] = "Generated by the procedural prototype pack for deterministic placement."
    if spec.asset_id == "chr_proto_humanoid_01":
        metadata["collision"] = "col_chr_proto_humanoid_01_capsule"
    return metadata
