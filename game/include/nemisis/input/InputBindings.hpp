...
inline constexpr std::string_view PickupWeapon = "pickup_weapon";
inline constexpr std::string_view SwitchWeaponPrimary = "switch_weapon_primary";
inline constexpr std::string_view SwitchWeaponSmg = "switch_weapon_smg";
inline constexpr std::string_view SwitchWeaponSidearm = "switch_weapon_sidearm";
...
inline constexpr std::uint16_t F = 70;
...
inline constexpr std::uint16_t Digit4 = 52;
inline constexpr std::uint16_t Digit5 = 53;
inline constexpr std::uint16_t Digit6 = 54;
